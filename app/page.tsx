import { Scale, CreditCard, Heart, Home, UtensilsCrossed, Dumbbell, HardHat, ShoppingBag, FileSearch, UserCheck, Github, Mail, ExternalLink, ArrowRight } from 'lucide-react';
